...
public class Ex11_Array {
	...
	public static void main(String[] args) {
		...
		System.out.println(score[0]); // 첫번째요소
		System.out.println(score[4]); // 마지막요소

		sum = 0; // 초기화 * 변수.length = 배열의길이
		...
		double[] doubleArray = { 5.2, 2.3, 9, 2, 4.5 }; // 초기화 값을 { }로 제공
		String[] strArray = new String[5]; // 갯수만 정해서 배열을 생성

		int a;
		int[] b = new int[3];
		/* System.out.println(a); ---> 초기화하지 않은 변수a를 참조해서 에러 */
